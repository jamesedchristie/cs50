    ...
    for (int i = 0; i < voter_count; i++)
    {
        ...
        do
        {
            ...
            do
            {
                ...
                {
                    //Tallies vote when matches non-eliminated candidate
            ...
            //Terminates when match made to candidate
            while (preferences[i][j] != k);
        }
        //Only terminates when match made to non-eliminated candidate
